...
Fragments present:
- `paper_source.md` - no-self-evidence as a software boundary; using a screen vs. evidencing an ontology.
- `scholarship.md` - source-role discipline preventing claim inflation across domains.
- `practice_protocols.md` - practice interfaces stay outcome-independent and safety-bounded.
- `criticality.md` - criticality stays a proxy vocabulary / target shape for future adapters.
- `compassion_proxy.md` - care/compassion stay normatively bounded scope-of-modeling numbers.
