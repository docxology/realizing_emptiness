...
Fragments present:
- `paper_source.md` - returns the closing claim to the source paper and its recapitulation boundary.
- `qfep.md` - closes the implemented finite qFEP/quantum extension layer without crossing into physical qFEP evidence.
- `evidence_ceiling.md` - names the empirical, clinical, neural, awakening, practice, and physical-qFEP ceilings.
- `limitations.md` - recaps the no-self-evidence arc (screen, frames, separation prior, BMR,
