...
Fragments present:
- `_lead.md` - signpost for the supplemental audit and reproducibility surfaces.
- `symbol_glossary.md` - notation table for registry and displayed surrogate equations.
- `qfep.md` - supplemental finite quantum and contextuality audits (e.g. internal-cut unmeasurability).
- `criticality.md` - seeded criticality indicators and null/ensemble boundaries.
- `compassion_proxy.md` - finite policy-scope compassion surrogate and precision-ablation control.
- `scholarship.md` - source-role ledger separating recapitulation from background/proxy/terminology.
- `practice_protocols.md` - practice protocol mappings as bounded model interventions.
- `contemplative_inquiry.md` - inquiry lenses as outcome-independent software inspection scaffolds.
