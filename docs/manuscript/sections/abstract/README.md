...
Fragments present:
- `paper_source.md` - frames the 2026 no-self-evidence preprint as a source-anchored artifact and its central claim.
- `qfep.md` - summarizes the finite qFEP/QRF equation-to-surrogate mapping and blocked evidence classes.
- `qrf.md` - states QRF deployments as policies over boundary-channel sectorisations.
- `bmr.md` - states the Bayesian model reduction sweep over the separation prior.
