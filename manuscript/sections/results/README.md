...
Fragments present:
- `_lead.md` - signpost following the no-self-evidence chain through the result sequence.
- `qrf.md` - QRF channel-relabeling ledger and invariance/policy-flow figures; boundary-screen geometry is introduced in the Introduction.
- `qfep.md` - finite quantum scope summary (detail deferred to the supplement).
