...
- Edit the per-track `*.md` fragments here; never edit the composed `manuscript/03_results.md`.
- Each fragment maps to a `(section=results, track)` row in `manuscript/sheaf/manifest.yaml`;
